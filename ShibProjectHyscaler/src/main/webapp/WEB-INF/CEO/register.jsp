			...
			<div class="col-md-4 offset-md-4">
				<div class="car paint-card">
					<div class="card-body bg-light">
						<p class="fs-4 text-center">CEO Registration</p>
						<%String str =(String) session.getAttribute("message"); 
						if(str!=null){
						out.println(str);
						session .removeAttribute("message");
						}%>
						<form action="CEOregisterSubmit" method="post" >
							<div class="mb-3">
							...
							<div class="mb-3">
								<label class="form-label">Current organization</label> <input name="previous_organization"
									type="text" class="form-control" required>
							</div>
							<div class="mb-3">
						...
						<p class ="fs-4">
							Already have an account ?<a href="CEOLogin" class="text-decoration-none text-success">Login</a>
						</p>
					</div>
				</div>
			</div>
